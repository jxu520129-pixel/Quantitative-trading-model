...
def build_parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("scheduler", help="启动长期运行的 09:35/15:20/15:35 定时调度器")
    sub.add_parser("after-close", help="执行一次 15:20 行情更新、信号和委托排队流程")
    sub.add_parser("end-of-day", help="执行一次 15:35 收盘估值与风控流程")
